//g++ -O2 miracl_benchmark_poly2.cc ../home/vagrant/miracl/poly2mod.o ../home/vagrant/miracl/poly2.o ../home/vagrant/miracl/ec2.o ../home/vagrant/miracl/gf2m.o ../home/vagrant/miracl/ecn.o ../home/vagrant/miracl/crt.o ../home/vagrant/miracl/zzn.o ../home/vagrant/miracl/big.o ../home/vagrant/miracl/miracl.a -I../home/vagrant/miracl -std=c++11 -isystem ../home/vagrant/benchmark/include/ -lbenchmark -lpthread -L../home/vagrant/benchmark/build/src -o mybench
...
static void BM_PolynomField2_Scalar_Multiplication(benchmark::State& state, Poly2 poly2, Big scalar, BOOL check)
{
    for (auto _ : state) {
        poly2 + scalar;
    }
...
BENCHMARK_CAPTURE(BM_PolynomField2_Scalar_Multiplication, basic_scalar_multiplication, pow2(x,200)+pow2(x,104)+pow2(x,102)+pow2(x,69)+pow2(x,3)+x, Big(""), modulo(409, 7, 5, 3, TRUE));
